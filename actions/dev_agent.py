...
PROJECTS_DIR     = Path.home() / "Desktop" / "RENCORA_Projects"
MAX_FIX_ATTEMPTS = 5
...
_qa = QAAgent()
_is_rate_limit    = _qa.is_rate_limit
_parse_traceback  = _qa.parse_traceback
_classify_error   = _qa.diagnose
_has_error        = _qa.has_error
...
def _build_project(
    ...
    proj_name    = project_name or plan.get("project_name", "rencora_project")
