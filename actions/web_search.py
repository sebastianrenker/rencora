...
def _news(query: str) -> str:
    ...
    try:
        ...
        print(f"[WebSearch]  News Gemini failed ({e}) — DDG fallback...")
...
def web_search(
    ...
    try:
        ...
        if mode == "news":
            print("[WebSearch]  News mode...")
            result = _news(query)
            print("[WebSearch]  News done.")
            return result

        if mode == "research":
            print("[WebSearch]  Research mode...")
            result = _research(query)
            print("[WebSearch]  Research done.")
            return result

        if mode == "price":
            print("[WebSearch]  Price mode...")
            result = _price(query)
            print("[WebSearch]  Price done.")
            return result
